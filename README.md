...
See [functionality details](#Functionality%20Details) for more
# Usage
...
```
## Example Use Case
The default configuration is for the example use case where every time an issue is labeled "enhancement" The title of the issue is added to the readme under the heading **Upcoming Features**.<br>This repository uses this action for exactly this! See [Upcoming Features](#Upcoming%20Features)!

# Functionality Details
## Where is the issue title added?
...
## When is the issue title removed?
- An issue with the specified label is closed
- The specified label is removed from an issue
- An issue with the specified label is deleted
## What happens if an issue with the label has its title edited?
