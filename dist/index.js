...
Object.defineProperty(exports, "__esModule", ({ value: true }));
class Section {
    constructor(heading, headingType, caseSensitive = false) {
        this.heading = "";
        this._lines = [];
        if (heading)
            this.setHeading(heading, caseSensitive);
    ...
    setHeading(heading, caseSensitive) {
...
function sectionMarkdown(lines, caseSensitive = false) {
    ...
    for (const line of lines) {
        ...
        if (/^\s*#{1,6}\s+/m.test(line)) {
            ...
            if (currentSection.lines() === 0 && currentSection.headingType === 0 /* none */) {
                ...
                currentSection = new Section_1.default(line, 1 /* hash */, caseSensitive);
            }
            ...
            if (currentSection.lastLine().length > 0 && !/^-{3,}\s*$/m.test(currentSection.lastLine())) {
                ...
                currentSection = new Section_1.default(heading, 2 /* underline */, caseSensitive);
                currentSection.addLine(heading);
            }
        }
        currentSection.addLine(line);
    }
    if ((currentSection.lines() > 0 || currentSection.headingType !== 0 /* none */) && !sections.has(currentSection.heading)) {
        sections.set(currentSection.heading, currentSection);
    }
    return sections;
}
exports["default"] = sectionMarkdown;
